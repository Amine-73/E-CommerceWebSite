    ...
    <>
      ...
      <Container sx={{ display: "inline-block" }}>
        ...
        <div style={{ margin: "35px 0px" }}>
          ...
          >
            <WhatsAppIcon style={{ fontSize: "40px", color: "#000" }} />
          </a>
          <a
            ...
            style={{ margin: "0px 6px" }}
          >
            <InstagramIcon style={{ fontSize: "40px", color: "#000" }} />
          </a>
          <a
            ...
            style={{ margin: "0px 6px" }}
          >
            <LinkedInIcon style={{ fontSize: "40px", color: "#000" }} />
          </a>
          <a
            ...
            style={{ margin: "0px 6px" }}
          >
            <FacebookIcon style={{ fontSize: "40px", color: "#000" }} />
          </a>
        </div>
      </Container>
      <div
