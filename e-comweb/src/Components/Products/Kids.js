        ...
        <section style={{ marginTop: "90px" }}>
          <Card
            sx={{
              ...
              borderRadius: "30px",
              background:
                "url(https://img.freepik.com/free-photo/interested-gentle-tender-young-s-ginger-woman-red-warm-sweater-pointing-looking-upper-left_1258-142103.jpg?semt=ais_hybrid&w=740&q=80)",
              ...
              <Grid size={8} style={{ display: "flex" }}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: "40px", textAlign: "left" }}>
                    {" "}
                    <span style={{ color: "#fff" }}> 12</span> Hours{" "}
                    <span style={{ color: "#fff" }}>20</span> Mins
                  </h3>
                  <Button
                    variant="contained"
                    style={{
